...
public class AlgaePivotConstants {
    ...
    public static final double kGroundIntakePositionRotations = .48 * 2/3;
    public static final double kLollypopIntakePositionRotations = .385 * 2/3; 
    public static final double kReefTreeIntakePositionRotations = .49 * 2/3; 
