...
public class Robot extends LoggedRobot {
    ...
    private NetworkTablesChangableValue autonDebugMode = new NetworkTablesChangableValue("RobotMode/AutonDebugMode",
            RobotModeConstants.kAutonDebugMode);
    private ArrayList<CompletableFuture<CMPathPoint[]>> CMPaths = new ArrayList<CompletableFuture<CMPathPoint[]>>();
    ...
    public void robotInit() {
        ...
        // BuiltConstatns is generated when the project is built. No imports or anything
        // is needed if it is red underlined just build the project
        // Record metadata
    ...
    public Pose2d getTargetedAutonPosition() {
        ...
        /*
         * boolean isStartingOnOtherBarge = Tolerance.inTolorance(robotPosition.getY(),
         * AutonPointManager.kOtherAllianceBargeStartPosition.getAutonPoint().getY(),
         * 1.0);
         * return isStartingOnOtherBarge ?
         * AutonPointManager.kOtherAllianceBargeStartPosition.getAutonPoint() :
         * AutonPointManager.kOwnAllianceBargeStartPosition.getAutonPoint();
         */
        if (Tolerance.inTolorance(robotPosition.getY(),
                AutonPointManager.kOwnAllianceBargeStartPosition.getAutonPoint().getY(), 1)) {
    ...
    public void disabledPeriodic() {
        ...
        boolean[] tolerances = Tolerance.inTolerancePose2d(desiredPosition, actualPosition,
                ControlConstants.robotStartPositionTolorence);
