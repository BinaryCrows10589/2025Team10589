...
public class FudgeFactor {
    ...
    public Pose2d getAllianceFudgeFactors() {
        return RobotModeConstants.isBlueAlliance ? getBlueFudgeFactors() : getRedFudgeFactors();
    }
    ...
    public double getAllianceAngleOfAttackFudgeFactor() {
        return RobotModeConstants.isBlueAlliance ? this.getBlueAngleOfAttackFudgeFactor() : this.getRedAngleOfAttackFudgeFactor();
    }
}
