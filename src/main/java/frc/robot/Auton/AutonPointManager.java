...
public class AutonPointManager {
    ...
    public static final AutonPoint kPlaceOnCoralK = new AutonPoint(5.04, 2.88, -62.5, 180, false);
    ...
    public static final AutonPoint kPlaceOnCoralI = new AutonPoint(3.8, 2.9, -115, 50, false);
    public static final AutonPoint kLeaveFromPlaceOnCoralI = new AutonPoint(3.85, 3.07, -120, -130, false);
    public static final AutonPoint kPlaceOnCoralH = new AutonPoint(3.69, 2.91, -127.5, -310, false);
