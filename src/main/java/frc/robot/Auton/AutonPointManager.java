...
public class AutonPointManager {
    ...
    public static final AutonPoint kPlaceOnCoralK = new AutonPoint(5.09, 2.865, -62.5, 180, false);
    ...
    public static final AutonPoint kPlaceOnCoralH = new AutonPoint(3.8, 2.9, -127.5, -310, false);
