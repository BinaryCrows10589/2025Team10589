...
public class PlaceCoralKAndIAndHStartingOnOtherAliance {
    public static Command getAuton(
        ...
        autonCommands.add(PlaceCoralKAndIAndHumanPlayerStationStartingOnOtherAliance.getAuton(driveCommandFactory, driveSubsystem, elevatorCommandFactory, outtakeCommandFactory));
