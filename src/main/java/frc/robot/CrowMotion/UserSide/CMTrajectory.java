...
public class CMTrajectory {
    ...
    private double calculateDesiredVelocity(double currentVelocityMag,
        ...
        if(shouldDecelerate) {
            ...
            double percent = distenceToEnd / initialDistenceToEnd;
            ...
            desiredVelocity = Math.max((velocityDelta * clamp(0, 1, percent) + endVelocity - CMConfig.getMinMoveVelocity()), this.endVelocity);
        } else {
