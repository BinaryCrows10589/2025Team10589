...
public class RobotContainer {  
    ...
    public Command getAutonomousCommand() {   
      ...
      // this.placeCommand;//
        return this.autonManager.getSelectedAuton();//ParallelCommandGroup(this.elevatorCommandFactory.createElevatorToL2Command(), this.outtakeCommandFactory.createOuttakeCoralCommand());//;
    }
